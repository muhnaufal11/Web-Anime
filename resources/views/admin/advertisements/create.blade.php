...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Tambah Iklan Baru</h1>
            <p class="text-gray-400 text-sm mt-1">Buat iklan AdSense atau custom</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.advertisements.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-[#1a1d24] rounded-xl p-6 border border-white/10 space-y-4">
            ...
            <div id="codeField">
                <label class="block text-sm font-bold text-gray-300 mb-2">Kode Iklan (AdSense / HTML / JavaScript)</label>
                <textarea name="code" rows="6"
                          ...
                          placeholder="Paste kode AdSense atau HTML custom di sini...">{{ old('code') }}</textarea>
                <p class="text-gray-500 text-xs mt-1">Untuk Google AdSense, paste kode yang didapat dari dashboard AdSense</p>
            </div>

            <!-- Image Upload (for image type) -->
            <div id="imageField" class="hidden">
                <label class="block text-sm font-bold text-gray-300 mb-2">Upload Gambar</label>
                ...
                <p class="text-gray-500 text-xs mt-1">Format: JPEG, PNG, GIF, WebP. Maks 2MB</p>
            </div>
